<template>
  <div class="productAdd">
    ...
    <v-row style="padding:12px 24px">
      <v-col cols="5">
        <v-text-field dense :label="$t('turkmen')+' '+$t('name')" :rules="rules" v-model="product.name_tm" disabled="true"></v-text-field>
      </v-col>
      <v-col cols="1"></v-col>
      <v-col cols="5">
        <v-text-field dense :label="$t('rus')+' '+$t('name')" :rules="rules" v-model="product.name_ru" disabled></v-text-field>
      </v-col>
      <v-col cols="5">
        <v-text-field dense :label="$t('eng')+' '+$t('name')" :rules="rules" v-model="product.name_en" disabled></v-text-field>
      </v-col>
    </v-row>
    ...
    <v-row style="padding:12px 24px">
      <v-col cols="3"><v-text-field dense :label="$t('productCode')"  v-model="product.product_code" disabled></v-text-field></v-col>
      <v-col cols="2"><v-text-field dense :label="$t('stock')" disabled :rules="rules" type="number" min="0" v-model="product.stock"></v-text-field></v-col>
      <v-col cols="1"></v-col>
      <v-col cols="2"><v-text-field dense type="number" min="0" :label="$t('price')" :rules="rules" disabled v-model="product.price"></v-text-field></v-col>

      <v-col cols="2">
        <v-text-field dense type="number" :label="$t('discount')" v-model="product.discount" disabled></v-text-field>
      </v-col>
    </v-row>
