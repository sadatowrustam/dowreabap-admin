...
export default {
  ...
  methods:{
    ...
    async sendProduct(){
      ...
      if(this.images && this.product.name_tm && this.product.name_ru && this.product.product_code && this.product.stock && this.product.price &&  this.product.category_id){ //body bosh bolup barsa mesele bolarmy soramaly
        try {
